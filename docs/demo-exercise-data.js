export const exercises = [
  {
    ...
    hint: "Follow the highlights: Linear Algebra → [ ] → 2×2."
  },
  {
    ...
    hint: "Simply write `int` to insert an integral."
  },
  {
  ...
  },
  {
    ...
    hint: "Simply write `sum` to insert a summation."
  },
  {
    ...
    hint: "Simply write `\\lim` and press Enter to insert a limit."
  }
];
